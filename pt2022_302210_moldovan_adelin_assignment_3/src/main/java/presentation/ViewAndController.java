...
public final class ViewAndController extends JFrame implements ActionListener {
     ...
     *
     * @param dial  -dial
     * @param labelSterge1  -label1
     * @param labelSterge2  -label2
     * @param optionSet -optionSet
     * @param text1 -text1
     * @param updateButton -button update
     */
     ...
     * @param dial -dial
     * @param updateButton -button update
     * @param labelUpgrade1 -label1
     * @param labelUpgrade2 -label2
     * @param optionWhere -option where to update
     * @param text2 -text2
     */
     ...
     * rezultat.
     *
     * @param paneRezultat1 -pane rez2
     * @param dial -dial
     * @param paneRezultat2 -pane rez2
     */
     ...
     * @param text2 -text2
     * @param text1 -text1
     * @param labelInserare1 -label1
     * @param labelInserare2 -label2
     * @param labelInserare3 -label3
     * @param labelInserare4 -label4
     * @param labelInserare5 -label5
     * @param paneInserare1 -pane1
     * @param paneInserare2 -pane2
     * @param text3 -text
     * @param text4 -text
     * @param text5 -text
     *
    ...
    /**
     * public static String[] getNumeColoana
     *
     * @param object -obj
     *
     */
    ...
    /**
     * public void getProprietati method.
     *
     * @param <T>  -T
     * @param lista -lista
     */
    ...
    /**
     * The type ViewAndController.
     *
     * @param name -string name
     */
    public ViewAndController(String name) {
        super(name);
        gridConstraints.gridx = 0;
        gridConstraints.gridy = 0;
